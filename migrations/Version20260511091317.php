...
final class Version20260511091317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehiculo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, matricula VARCHAR(20) NOT NULL, marca VARCHAR(50) NOT NULL, modelo VARCHAR(50) NOT NULL, vin VARCHAR(50) DEFAULT NULL, propietario_id INTEGER DEFAULT NULL, CONSTRAINT FK_C9FA160353C8D32C FOREIGN KEY (propietario_id) REFERENCES usuario (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
